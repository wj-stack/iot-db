...
type Data struct {
	...
	Kv map[int32]int64 `protobuf:"bytes,1,rep,name=kv,proto3" json:"kv,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *Data) GetKv() map[int32]int64 {
	if x != nil {
		return x.Kv
	}
	return nil
...
var file_pb_proto_rawDesc = []byte{
	0x0a, 0x08, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5c, 0x0a, 0x04, 0x44, 0x61,
	0x74, 0x61, 0x12, 0x1d, 0x0a, 0x02, 0x6b, 0x76, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d,
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x4b, 0x76, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x02, 0x6b,
...
var file_pb_proto_depIdxs = []int32{
	1, // 0: Data.kv:type_name -> Data.KvEntry
